...
namespace gfx {
	...
	Pipeline::Pipeline( Pipeline &&other ) noexcept:
		...
		m_p_fragment_shader_module { std::move( other.m_p_fragment_shader_module ) },
		m_p_pipeline_layout        { std::move( other.m_p_pipeline_layout        ) },
	...
	{
		spdlog::info( "Move assigning a Pipeline instance..." );
		m_p_vertex_shader_module   = std::move( other.m_p_vertex_shader_module   );
		m_p_fragment_shader_module = std::move( other.m_p_fragment_shader_module );
		m_p_pipeline_layout        = std::move( other.m_p_pipeline_layout        );
		m_p_render_pass            = std::move( other.m_p_render_pass            );
