...
namespace gfx {
	class Pipeline {
		public:
			...
			[[nodiscard]] vk::raii::RenderPass const & get_render_pass() const;
			[[nodiscard]] vk::raii::RenderPass       & get_render_pass()      ;
			[[nodiscard]] vk::raii::Pipeline   const & access()          const;
			[[nodiscard]] vk::raii::Pipeline         & access()               ;
		private:
